...
import ru.alexeyp.searchrepo.di.start.StartModule;
...
public class StartActivity extends AppCompatActivity {
    ...
    private void initScope() {
        Toothpick.openScopes(Scopes.APP_SCOPE, Scopes.START_SCOPE).installModules(new StartModule());
        Scope scope = Toothpick.openScopes(Scopes.START_SCOPE, Scopes.START_ACTIVITY_SCOPE);
